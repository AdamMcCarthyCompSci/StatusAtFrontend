export default {
  ...
  nameHelper: 'Este nome será visível para os membros da sua equipe e clientes',
  creating: 'Criando...',
  whatHappensNext: 'O que acontece a seguir?',
  becomeOwner: 'Você se tornará automaticamente o proprietário da organização',
  inviteMembers: 'Você pode convidar membros da equipe para colaborar',
  createFlows: 'Comece a criar fluxos para rastrear atualizações de status',
