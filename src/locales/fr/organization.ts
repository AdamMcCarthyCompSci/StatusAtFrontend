export default {
  ...
  nameReserved:
    'Ce nom est réservé par le système. Veuillez choisir un nom différent',
  ...
  becomeOwner: "Vous deviendrez automatiquement propriétaire de l'organisation",
  inviteMembers: "Vous pouvez inviter des membres de l'équipe à collaborer",
  createFlows:
