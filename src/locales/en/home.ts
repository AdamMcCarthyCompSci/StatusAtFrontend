export default {
  ...
  demo: {
    ...
    building: 'Building...',
    complete: 'Complete',
    customStatusFlow: 'Custom Status Flow',
    ...
    waiting: 'Waiting...',
    active: 'Active',
    waitingForAdmin: 'Waiting for admin to build flow...',
    statusStepsCreated: '{{count}}/{{total}} status steps created',
    yourProgress: 'Your Application Progress',
    settingUp: 'Setting up...',
    stepCount: 'Step {{current}} of {{total}}',
    customFlowPreparing: 'Your custom flow is being prepared...',
    trackProgress: 'Track your progress through each step',
