export default {
  ...
  organization: {
    ...
    trackResourceConsumption: "Track your organization's resource consumption",
    ...
    teamMembersLimitReached: 'Budget reached! Cannot invite new team members.',
    ...
    identifierExample: 'Example format',
