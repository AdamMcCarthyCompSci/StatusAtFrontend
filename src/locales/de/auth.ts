export default {
  ...
  signUpDescription: 'Registrieren Sie sich für ein neues Konto, um loszulegen',
  ...
  resetLinkSentTo: 'Wir haben einen Passwort-Zurücksetzungslink gesendet an',
  didntReceiveEmail:
  ...
  sentNewConfirmationTo: 'Wir haben eine neue Bestätigungs-E-Mail gesendet an',
  ...
  // Invite Context
  invitedToEnroll: 'Sie wurden eingeladen, sich in {{flowName}} einzuschreiben',
  signingInToJoin:
