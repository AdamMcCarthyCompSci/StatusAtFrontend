export default {
  ...
  nameReserved:
    'Dieser Name ist vom System reserviert. Bitte wählen Sie einen anderen Namen',
  ...
  chooseUniqueName: 'Wählen Sie einen eindeutigen Namen für Ihre Organisation',
  organizationNameRequired: 'Organisationsname *',
  namePlaceholder: 'Geben Sie den Organisationsnamen ein (z.B. Acme Corp)',
  nameHelper: 'Dieser Name ist für Ihre Teammitglieder und Kunden sichtbar',
