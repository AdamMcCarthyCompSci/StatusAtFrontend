export default {
  ...
  profileDescription: 'Actualiza tu información personal y datos de contacto',
  fullName: 'Nombre Completo',
  fullNamePlaceholder: 'Ingresa tu nombre completo',
  emailAddress: 'Dirección de Correo Electrónico',
  emailPlaceholder: 'Ingresa tu dirección de correo electrónico',
  emailCannotBeChanged: 'La dirección de correo no se puede cambiar',
  ...
  accountManagementDescription: 'Gestiona la seguridad y datos de tu cuenta',
