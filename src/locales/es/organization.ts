export default {
  ...
  nameReserved:
    'Este nombre está reservado por el sistema. Por favor, elija un nombre diferente',
  ...
  namePlaceholder: 'Ingrese el nombre de la organización (ej., Acme Corp)',
  nameHelper:
  ...
  subscribeToPlan: 'Suscríbete a un plan para desbloquear todas las funciones',
};
