      ...
      <div className="container mx-auto max-w-4xl px-4 py-8">
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <p>
              These Terms of Service ("Terms") govern your use of StatusAt, a
              status tracking and customer communication platform operated by
              Suber Oak Limited ("Company," "we," "our," or "us").
            </p>
            <p>
        ...
        <Card className="mt-6">
          ...
          <CardContent className="space-y-4">
            <p>StatusAt provides a platform that allows businesses to:</p>
        ...
        <Card className="mt-6">
          ...
          <CardContent className="space-y-4">
            <div>
              <h3 className="mb-2 text-lg font-semibold">Your Content</h3>
              <p>
                You retain ownership of all content and data you upload to our
                platform. By using our service, you grant us a limited license
                to use, store, and process your content solely for the purpose
            ...
            <div>
              ...
              <p>
                When you use our platform to communicate with customers, you are
                responsible for ensuring you have proper consent and
                authorization to process their personal information. You must
                comply with all applicable data protection laws.
              </p>
            </div>
            <div>
              <h3 className="mb-2 text-lg font-semibold">Our Content</h3>
              <p>
                The platform, including its design, functionality, and content,
                is owned by us and protected by intellectual property laws. You
                may not copy, modify, or distribute our proprietary content
                without permission.
              </p>
            </div>
          </CardContent>
        ...
        <Card className="mt-6">
          ...
          <CardContent className="space-y-4">
            <p>
              ...
              associated with your subscription. Payment terms include:
            </p>
            <ul className="ml-4 list-inside list-disc space-y-1">
        ...
        <Card className="mt-6">
          ...
          <CardContent className="space-y-4">
            ...
            <p>
              ...
              but you acknowledge that no system is completely secure and we
        ...
        <Card className="mt-6">
          ...
          <CardContent className="space-y-4">
            <p>
              You agree to indemnify and hold harmless Suber Oak Limited and its
        ...
        <Card className="mt-6">
          ...
          <CardContent className="space-y-4">
            <p>
              ...
              the laws of the jurisdiction where Suber Oak Limited is
        ...
        <Card className="mt-6">
          ...
          <CardContent className="space-y-4">
            <p>
              ...
              notify users of material changes by email or through the platform.
        ...
        <Card className="mt-6">
          ...
          <CardContent className="space-y-4">
            <ul className="ml-4 list-inside list-disc space-y-1">
              ...
              <li>
                <strong>Force Majeure:</strong> We are not liable for delays due
