  ...
  return (
    <React.Fragment>
      <AppShell.Main>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Crochet Crafters.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Crochet Crafters, accessible
              from{" "}
              <a
                href="https://crochetcrafters.com"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://crochetcrafters.com
              </a>
            </p>
          </li>
          <li>
        ...
        <ul>
          <li>By email: hello@crochetcrafters.com</li>
        </ul>
      </AppShell.Main>
    </React.Fragment>
  );
